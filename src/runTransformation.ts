...
const debug = createDebug('kdu-codemod')
...
type KduTransformationModule =
  | KduTransformation
  | {
      default: KduTransformation
    }

type TransformationModule = JSTransformationModule | KduTransformationModule
...
export default function runTransformation(
  ...
  let transformation: KduTransformation | JSTransformation
  // @ts-ignore
  ...
  if (transformation instanceof KduTransformation) {
